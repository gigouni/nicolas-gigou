...
?>
		...
		<div id="contact_content" class="contact">
			<div class="grid-2">
				<!-- Google Map -->
				<div class="contact_google_map small-hidden tiny-hidden">
				...
				<div class="contact_contact_ways">
					<div class="contact_contact_way address small-row tiny-row">
					...
					<div class="contact_contact_way email small-row tiny-row">
					...
					<div class="contact_contact_way phone small-row tiny-row">
					...
					<div class="contact_contact_way legalNotice small-row tiny-row">
						<p><span class="contact_contact_title legalNotice"><a href="#" title="Mentions légales du site nicolas-gigou.fr" id="legalNotice_link"><i class="fa fa-balance-scale"></i> Mentions légales</a></span></p>
					</div>
				</div>
			</div>
